...
{
    public static void INC_ZERO_PAGE(Cpu cpu, out int outCycle)
    {
    ...
    public static void INC_ZERO_PAGE_X(Cpu cpu, out int outCycle)
    {
    ...
    public static void INC_ABSOLUTE(Cpu cpu, out int outCycle)
    {
    ...
    public static void INC_ABSOLUTE_X(Cpu cpu, out int outCycle)
    {
