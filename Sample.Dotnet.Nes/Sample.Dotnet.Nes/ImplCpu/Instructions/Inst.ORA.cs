...
{
    private static void _ORA(Cpu cpu, u8 v)
    {
        cpu.Register.A |= v;
    ...
    public static void ORA_IMMEDIATE(Cpu cpu, out int outCycle)
    {
        u8 v = cpu.FetchByte();
        _ORA(cpu, v);
    ...
    public static void ORA_ZERO_PAGE(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_ZERO_PAGE_X(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_ABSOLUTE(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_ABSOLUTE_X(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_ABSOLUTE_Y(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_INDIRECT_X(Cpu cpu, out int outCycle)
    {
    ...
    public static void ORA_INDIRECT_Y(Cpu cpu, out int outCycle)
    {
